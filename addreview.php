    ...
    if ($conn->connect_error) {
        ...
        if ($user_result->num_rows == 0) {
            ...
            if ($res_result->num_rows == 0) {
                $sql="INSERT INTO restaurants (Res_name, Cuisine, D_from_campus, Address)
            ...
            if ($food_result->num_rows == 0) {
                $sql="INSERT INTO food_items(Res_name, I_name, Photo)
                      VALUES ('$restaurant', '$item', '')";
                mysqli_query($conn, $sql);
            }

            // Insert into review table
            $sql="INSERT INTO reviews(Res_name, Rev_id, Rating, Rev_comment, I_comment, Username, Fav_item)
                  VALUES ('$restaurant', '6', '$rating', '$review', '$reason', '$uname', '$item')";
            mysqli_query($conn, $sql);
